...
bool plsregressioncv(arma::mat X, arma::mat Y, int components, arma::mat& X_loadings, arma::mat& Y_loadings, arma::mat& X_scores,
    arma::mat& Y_scores, arma::mat& Weights, arma::mat& Beta, arma::mat& percent_var, arma::mat& Predicted, double& rsquaredPLS,
    double& RMSE)
{
    ...
    //Weights   
    Weights = R;
    //cout << "Number of Rows and columns of Weights Matrix: " << size(Weights) << endl;
